...
// Memory management
            ...
            var STATIC_BASE = 1024,
                ...
                STACKTOP = STACK_BASE,
                STACK_MAX = 5299584,
                DYNAMIC_BASE = 5299584,
                DYNAMICTOP_PTR = 56496;
...
// ASM_LIBRARY EXTERN PRIMITIVES: Int8Array,Int32Array,Math_floor,Math_ceil
            ...
            var debug_table_iiii = [0, '___stdio_write', '__ZNK10__cxxabiv117__class_type_info9can_catchEPKNS_16__shim_type_infoERPv', 0];
            var debug_table_iiiiiii = [0, '_resampler_basic_direct_double', '_resampler_basic_direct_single', '_resampler_basic_interpolate_double', '_resampler_basic_interpolate_single', '_resampler_basic_zero', 0, 0];
            var debug_table_jiji = [0, '___stdio_seek'];
            var debug_table_v = [0, '___cxa_pure_virtual'];
            var debug_table_vi = [0, '__ZN10__cxxabiv116__shim_type_infoD2Ev', '__ZN10__cxxabiv117__class_type_infoD0Ev', '__ZNK10__cxxabiv116__shim_type_info5noop1Ev', '__ZNK10__cxxabiv116__shim_type_info5noop2Ev', '__ZN10__cxxabiv120__si_class_type_infoD0Ev', '__ZN10__cxxabiv121__vmi_class_type_infoD0Ev', 0];
            var debug_table_viiii = [0, '__ZN9Container4initEjhi', '__ZN9Container10writeFrameEPvmi', '__ZN18ContainerInterface4initEjhi', '__ZNK10__cxxabiv117__class_type_info27has_unambiguous_public_baseEPNS_19__dynamic_cast_infoEPvi', '__ZNK10__cxxabiv120__si_class_type_info27has_unambiguous_public_baseEPNS_19__dynamic_cast_infoEPvi', '__ZNK10__cxxabiv121__vmi_class_type_info27has_unambiguous_public_baseEPNS_19__dynamic_cast_infoEPvi', 0];
            ...
            var debug_table_viiiiiii = [0, '_downmix_float'];
            var debug_tables = {
                'ii': debug_table_ii,
            ...
            var asmLibraryArg = {
                ...
                "__table_base": 0,
                "_abort": _abort,
                "_emscriptenPushBuffer": _emscriptenPushBuffer,
...
// EMSCRIPTEN_START_ASM
            ...
            var ___em_js__emscriptenPushBuffer = Module["___em_js__emscriptenPushBuffer"] = function () {
                assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                return Module["asm"]["___em_js__emscriptenPushBuffer"].apply(null, arguments)
            };
            ...
            var _emscripten_bind_Container_Container_0 = Module["_emscripten_bind_Container_Container_0"] = function () {
                assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                return Module["asm"]["_emscripten_bind_Container_Container_0"].apply(null, arguments)
            };

            var _emscripten_bind_Container___destroy___0 = Module["_emscripten_bind_Container___destroy___0"] = function () {
                assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                return Module["asm"]["_emscripten_bind_Container___destroy___0"].apply(null, arguments)
            };

            var _emscripten_bind_Container_init_3 = Module["_emscripten_bind_Container_init_3"] = function () {
                assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                return Module["asm"]["_emscripten_bind_Container_init_3"].apply(null, arguments)
            };

            var _emscripten_bind_Container_writeFrame_3 = Module["_emscripten_bind_Container_writeFrame_3"] = function () {
                assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                return Module["asm"]["_emscripten_bind_Container_writeFrame_3"].apply(null, arguments)
            };
...
// VoidPtr
            /** @suppress {undefinedVars, duplicate} */function VoidPtr() {
...
// Container
            /** @suppress {undefinedVars, duplicate} */function Container() {
            ...
            Container.prototype['init'] = Container.prototype.init = /** @suppress {undefinedVars, duplicate} */function (sample_rate, channel_count, serial) {
                var self = this.ptr;
                if (sample_rate && typeof sample_rate === 'object') sample_rate = sample_rate.ptr;
                if (channel_count && typeof channel_count === 'object') channel_count = channel_count.ptr;
                if (serial && typeof serial === 'object') serial = serial.ptr;
                _emscripten_bind_Container_init_3(self, sample_rate, channel_count, serial);
            };
            ;

            Container.prototype['writeFrame'] = Container.prototype.writeFrame = /** @suppress {undefinedVars, duplicate} */function (data, size, num_samples) {
                var self = this.ptr;
                if (data && typeof data === 'object') data = data.ptr;
                if (size && typeof size === 'object') size = size.ptr;
                if (num_samples && typeof num_samples === 'object') num_samples = num_samples.ptr;
                _emscripten_bind_Container_writeFrame_3(self, data, size, num_samples);
            };
            ;

            Container.prototype['__destroy__'] = Container.prototype.__destroy__ = /** @suppress {undefinedVars, duplicate} */function () {
                var self = this.ptr;
    ...
    workerGlobalScope.onmessage = function (e) {
        ...
        switch (command) {
            ...
            case 'done':
                ...
                self.postMessage({command: command === 'done' ? 'lastEncodedData' : 'encodedData', buffers}, buffers);
